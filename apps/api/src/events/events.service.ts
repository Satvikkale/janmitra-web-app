...
export class EventsService {
  ...
  async getEventStats(ngoId: string) {
    // Update event statuses before calculating stats
  ...
  async updateExpiredEvents() {
    ...
    // Update events that have passed their date and are still marked as 'upcoming' or 'ongoing'
  ...
  // Scheduled task to run every hour and update expired events
  ...
  // Manual trigger for immediate status updates
