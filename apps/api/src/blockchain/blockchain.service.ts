...
export class BlockchainService {
  ...
  /** Check if blockchain is configured and enabled */
  isEnabled(): boolean {
    return this.contract !== null;
  }

  /** Generate a SHA-256 hash of complaint data for on-chain storage */
  ...
  /** Record a new complaint on the blockchain */
  ...
  /** Record complaint assignment on the blockchain */
  ...
  /** Record status update on the blockchain */
  ...
  /** Verify complaint integrity by comparing on-chain hash */
  ...
  /** Get complaint record from blockchain */
