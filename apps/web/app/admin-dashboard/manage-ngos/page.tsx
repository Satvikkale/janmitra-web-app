        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5 hover:border-teal-300 transition-colors">
            <div className="flex justify-between items-start mb-3">
                <div>
                    ...
                    <p className="text-sm text-gray-500">{ngo.city} • {ngo.subtype}</p>
                </div>
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-md w-full text-center">
                    ...
                    <a 
                        href="/auth/login" 
                        className="inline-block bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded-md font-medium transition-colors"
                    >
                        Login
                    </a>
                </div>
